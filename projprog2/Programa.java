...
public class Programa {
	...
	public static void main(String[] args) {
		...
		Cliente cliente = new Cliente("Alan", "123123123", "rua tal", "123123" , "alan@alan.com", "32224242", null);
		...
		Promocoes promocao1 = new Promocoes(0.01, cliente, null);
		Promocoes promocao2 = new Promocoes(0.10, cliente, null);
